...
1. Inventory package component tags and imports. The complete supported surface
   is the eleven entries in [the v6 contract](specs/v6-public-contract.md).
...
5. Apply each module's documented CSP policy. Signature and Transfer List need
   the style-attribute exception; File Preview renders documents in its own
