...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'daisy::components.ui.data-display.table','data' => ['rowKey' => 'id','rowDetail' => 'inline','rowDetailView' => 'table-test::missing','columns' => [
            ['key' => 'name', 'label' => 'Name'],
        ],'rows' => [
            ['id' => 'user-1', 'name' => 'Jane'],
...
<?php endif; ?>
<?php $component->withAttributes(['row-key' => 'id','row-detail' => 'inline','row-detail-view' => 'table-test::missing','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['key' => 'name', 'label' => 'Name'],
...
<?php endif; ?><?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/tests/Fixtures/laravel/storage/framework/views/14b7dd8efe2ce4c8a48c7cee27e2f16c.blade.php ENDPATH**/ ?>