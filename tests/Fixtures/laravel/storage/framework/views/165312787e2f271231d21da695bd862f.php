...
<div <?php echo e($attributes->merge(['class' => $rootClasses])->merge($dataAttributes)); ?>>
    <div class="<?php echo e($shellClasses); ?>" data-role="shell">
        <div class="flex grow flex-wrap items-center gap-2" data-role="tokens">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $token): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <span class="<?php echo e($tokenClasses); ?>" data-token-item data-value="<?php echo e($token['value']); ?>" data-label="<?php echo e($token['label']); ?>">
                    <span class="truncate"><?php echo e($token['label']); ?></span>
                    <button
                        type="button"
                        class="<?php echo e($removeButtonClasses); ?>"
                        data-token-remove
                        aria-label="Remove <?php echo e($token['label']); ?>"
                    >
            ...
            <input
                ...
                autocomplete="off"
                placeholder="<?php echo e($placeholder ?? ($preset === 'email' ? 'Add recipients' : 'Add item')); ?>"
                aria-expanded="false"
    ...
    <div data-role="hidden-inputs">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $token): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submitName !== ''): ?>
                <input type="hidden" name="<?php echo e($submitName); ?>" value="<?php echo e($token['value']); ?>" data-token-hidden />
...
<?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/resources/views/components/ui/inputs/token-input.blade.php ENDPATH**/ ?>