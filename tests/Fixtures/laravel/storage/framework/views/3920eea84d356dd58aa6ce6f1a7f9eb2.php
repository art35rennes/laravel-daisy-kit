    ...
    <div class="min-h-[calc(100vh-8rem)] flex items-center justify-center">
        <div class="w-full max-w-md space-y-6">
            ...
            <div class="text-center space-y-1">
                ...
                <p class="text-base-content/70"><?php echo e(__('daisy::auth.forgot_password_description')); ?></p>
            </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                    ...
                    <?php echo e(__('daisy::auth.send_reset_link')); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loginUrl !== '#'): ?>
                <p class="text-center text-sm text-base-content/70">
                    <?php echo e(__('daisy::auth.remember_password')); ?>
...
<?php endif; ?>
<?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/resources/views/templates/auth/forgot-password.blade.php ENDPATH**/ ?>