...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'daisy::components.ui.data-display.table','data' => ['selection' => 'multiple','rowKey' => 'id','subRowsKey' => 'children','subRowSelection' => 'master-only','columns' => [['key' => 'name', 'label' => 'Name']],'rows' => [['id' => 'parent', 'name' => 'Parent', 'children' => [['id' => 'child', 'name' => 'Child']]]]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selection' => 'multiple','row-key' => 'id','sub-rows-key' => 'children','sub-row-selection' => 'master-only','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['key' => 'name', 'label' => 'Name']]),'rows' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['id' => 'parent', 'name' => 'Parent', 'children' => [['id' => 'child', 'name' => 'Child']]]])]); ?>
...
<?php endif; ?><?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/tests/Fixtures/laravel/storage/framework/views/ac130654f142726d233ca768b26e0408.blade.php ENDPATH**/ ?>