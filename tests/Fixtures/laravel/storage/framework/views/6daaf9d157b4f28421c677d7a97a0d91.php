...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'daisy::components.ui.advanced.blueprint','data' => ['nodeCategories' => [[
        'value' => 'safe',
...
<?php endif; ?>
<?php $component->withAttributes(['node-categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([[
        'value' => 'safe',
        'label' => '</textarea><script>alert(1)</script>',
        'defaults' => ['content' => '</textarea><img src=x onerror=alert(1)>'],
        'fields' => [[
...
<?php endif; ?><?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/tests/Fixtures/laravel/storage/framework/views/3468f8688dd53d870462ea31b935e582.blade.php ENDPATH**/ ?>