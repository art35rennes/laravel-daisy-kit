...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'daisy::components.ui.data-display.table','data' => ['rowKey' => 'id','rowDetail' => 'inline','rowDetailView' => 'table-test::table.detail','columns' => [
            ['key' => 'name', 'label' => 'Name'],
        ],'rows' => [
            ['id' => 'user-1', 'name' => 'Jane'],
...
<?php endif; ?>
<?php $component->withAttributes(['row-key' => 'id','row-detail' => 'inline','row-detail-view' => 'table-test::table.detail','columns' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['key' => 'name', 'label' => 'Name'],
...
<?php endif; ?><?php /**PATH /Users/asicard/.codex/worktrees/2849/laravel-daisy-kit/tests/Fixtures/laravel/storage/framework/views/a1e7e86f5256f26d11a4d4efbb887714.blade.php ENDPATH**/ ?>