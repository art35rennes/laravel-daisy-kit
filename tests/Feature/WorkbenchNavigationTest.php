...
it('uses the Workbench root as a module directory', function (): void {
    ...
    foreach (['table', 'tree', 'blueprint', 'file-preview', 'map', 'copyable', 'combobox', 'signature', 'truncate', 'scrollspy', 'transfer-list', 'code-editor'] as $module) {
...
it('renders every component module on its own route', function (string $module): void {
    ...
    foreach (['table', 'tree', 'blueprint', 'file-preview', 'map', 'copyable', 'combobox', 'signature', 'truncate', 'scrollspy', 'transfer-list', 'code-editor'] as $otherModule) {
    ...
    'combobox', 'signature', 'truncate', 'scrollspy', 'transfer-list', 'code-editor',
]);
