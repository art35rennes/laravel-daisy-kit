...
<section class="space-y-4 bg-base-200 p-6 rounded-box">
    ...
    <div class="space-y-3">
        <div class="flex flex-wrap items-center gap-4">
            <x-daisy::ui.avatar src="/img/people/dummy-100x100-Rosa.jpg" alt="Avatar" />
        ...
        <div class="flex flex-wrap items-center gap-4">
            <x-daisy::ui.avatar src="/img/food/dummy-100x100-Kiwi.jpg" status="online" />
            <x-daisy::ui.avatar src="/img/object/dummy-100x100-Commodore64.jpg" status="offline" />
            <div class="avatar-group -space-x-4 rtl:space-x-reverse">
                <x-daisy::ui.avatar src="/img/divers/dummy-100x100-Stripes.jpg" />
                <x-daisy::ui.avatar src="/img/business/dummy-100x100-Dollar.jpg" />
                <x-daisy::ui.avatar src="/img/people/dummy-100x100-Rosa.jpg" />
