@php
    ...
    $props = DocsHelper::getComponentProps('utilities', 'mockup-code');
@endphp

<x-daisy::layout.docs title="Mockup Code" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-mockup-code" class="tab" aria-label="Preview" checked />
    ...
    <pre data-prefix="$"><code>php artisan serve</code></pre>
            ...
            <input type="radio" name="base-example-mockup-code" class="tab" aria-label="Code" />
            <div class="tab-content bg-base-100 p-6">
                @php
