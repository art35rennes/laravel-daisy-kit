@php
    ...
    $props = DocsHelper::getComponentProps('utilities', 'mockup-window');
@endphp

<x-daisy::layout.docs title="Mockup Window" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-mockup-window" class="tab" aria-label="Preview" checked />
    ...
    <div class="p-4">Contenu de la fenêtre</div>
            ...
            <input type="radio" name="base-example-mockup-window" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
