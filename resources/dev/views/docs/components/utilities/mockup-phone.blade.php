@php
    ...
    $props = DocsHelper::getComponentProps('utilities', 'mockup-phone');
@endphp

<x-daisy::layout.docs title="Mockup Phone" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-mockup-phone" class="tab" aria-label="Preview" checked />
    ...
    <div class="mockup-phone-display">
        <div class="p-4">Application mobile</div>
            ...
            <input type="radio" name="base-example-mockup-phone" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
