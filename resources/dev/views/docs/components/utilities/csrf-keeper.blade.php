@php
    ...
    $props = DocsHelper::getComponentProps('utilities', 'csrf-keeper');
@endphp

<x-daisy::layout.docs title="Csrf Keeper" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-csrf-keeper" class="tab" aria-label="Preview" checked />
            <div class="tab-content bg-base-100 p-6">
                <div class="not-prose">
                    <x-daisy::ui.utilities.csrf-keeper />
                </div>
            </div>
            <input type="radio" name="base-example-csrf-keeper" class="tab" aria-label="Code" />
            <div class="tab-content bg-base-100 p-6">
                @php
