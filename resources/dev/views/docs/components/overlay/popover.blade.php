@php
    ...
    $props = DocsHelper::getComponentProps('overlay', 'popover');
@endphp

<x-daisy::layout.docs title="Popover" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Popover</h1>
        <p>Popover pour afficher des informations contextuelles.</p>
        <div class="alert alert-info mt-4">
            <span>Ce composant nécessite le module JavaScript <code>popover</code>.</span>
        </div>
    </section>
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-popover" class="tab" aria-label="Preview" checked />
    ...
    <p>Contenu informatif affiché dans le popover.</p>
            ...
            <input type="radio" name="base-example-popover" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
