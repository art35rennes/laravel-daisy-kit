@php
    ...
    $props = DocsHelper::getComponentProps('overlay', 'tooltip');
@endphp

<x-daisy::layout.docs title="Tooltip" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
