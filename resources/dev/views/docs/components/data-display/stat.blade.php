@php
    ...
    $props = DocsHelper::getComponentProps('data-display', 'stat');
@endphp

<x-daisy::layout.docs title="Stat" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Stat</h1>
        <p>Statistique avec titre, valeur et description.</p>
    </section>

    <section id="base" class="mt-10">
        <h2>Exemple de base</h2>
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-stat" class="tab" aria-label="Preview" checked />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                <div class="not-prose">
                    <x-daisy::ui.data-display.stat title="Ventes" value="1,234" desc="+20% ce mois" />
                </div>
            </div>
            <input type="radio" name="base-example-stat" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
