@php
    ...
    $props = DocsHelper::getComponentProps('data-display', 'avatar');
@endphp

<x-daisy::layout.docs title="Avatar" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Avatar</h1>
        <p>Avatar pour afficher une image de profil.</p>
    </section>
