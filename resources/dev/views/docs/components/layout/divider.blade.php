@php
    ...
    $props = DocsHelper::getComponentProps('layout', 'divider');
@endphp

<x-daisy::layout.docs title="Divider" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Divider</h1>
        <p>Séparateur visuel horizontal ou vertical.</p>
    </section>
