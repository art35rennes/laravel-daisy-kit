@php
    ...
    $props = DocsHelper::getComponentProps('layout', 'footer-layout');
@endphp

<x-daisy::layout.docs title="Footer Layout" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
