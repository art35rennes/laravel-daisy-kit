@php
    ...
    $props = DocsHelper::getComponentProps('advanced', 'chat-bubble');
@endphp
...
<x-daisy::layout.docs title="Chat Bubble" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    ...
    <section id="base" class="mt-10">
        ...
        <div class="tabs tabs-box">
            ...
            <div class="tab-content border-base-300 bg-base-100 p-6">
                <div class="not-prose">
                    <x-daisy::ui.advanced.chat-bubble align="start" name="Alice" time="14:30">
    Bonjour, comment allez-vous ?
            ...
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
                    $baseCode = '<x-daisy::ui.advanced.chat-bubble align="start" name="Alice" time="14:30">
    Bonjour, comment allez-vous ?
</x-daisy::ui.advanced.chat-bubble>';
                @endphp
        ...
        <div class="tabs tabs-box">
            ...
            <div class="tab-content border-base-300 bg-base-100 p-6">
                <div class="not-prose flex flex-wrap items-center gap-3">
                    <x-daisy::ui.advanced.chat-bubble color="primary">Primary</x-daisy::ui.advanced.chat-bubble>
                    <x-daisy::ui.advanced.chat-bubble color="secondary">Secondary</x-daisy::ui.advanced.chat-bubble>
                </div>
            </div>
            <input type="radio" name="variants-example-chat-bubble" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
                    $variantsCode = '&lt;x-daisy::ui.advanced.chat-bubble color=&quot;primary&quot;&gt;Primary&lt;/x-daisy::ui.advanced.chat-bubble&gt;
&lt;x-daisy::ui.advanced.chat-bubble color=&quot;secondary&quot;&gt;Secondary&lt;/x-daisy::ui.advanced.chat-bubble&gt;';
                @endphp
                <x-daisy::ui.advanced.code-editor 
                    language="blade" 
