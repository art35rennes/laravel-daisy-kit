@php
    ...
    $props = DocsHelper::getComponentProps('advanced', 'fieldset');
@endphp

<x-daisy::layout.docs title="Fieldset" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Fieldset</h1>
        <p>Groupe de champs de formulaire.</p>
    </section>

    <section id="base" class="mt-10">
        <h2>Exemple de base</h2>
        <div class="tabs tabs-box">
            <input type="radio" name="base-example-fieldset" class="tab" aria-label="Preview" checked />
    ...
    <x-daisy::ui.inputs.input name="email" placeholder="Email" />
            ...
            <input type="radio" name="base-example-fieldset" class="tab" aria-label="Code" />
            <div class="tab-content border-base-300 bg-base-100 p-6">
                @php
