@php
    ...
    $props = DocsHelper::getComponentProps('changelog', 'changelog-change-item');
@endphp

<x-daisy::layout.docs title="Changelog Change Item" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
