@php
    ...
    $props = DocsHelper::getComponentProps('communication', 'chat-header');
@endphp

<x-daisy::layout.docs title="Chat Header" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
