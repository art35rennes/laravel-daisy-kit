@php
    ...
    $props = DocsHelper::getComponentProps('communication', 'chat-sidebar');
@endphp

<x-daisy::layout.docs title="Chat Sidebar" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
