@php
    ...
    $props = DocsHelper::getComponentProps('navigation', 'sidebar-navigation');
@endphp

<x-daisy::layout.docs title="Sidebar Navigation" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
