@php
    ...
    $props = DocsHelper::getComponentProps('navigation', 'table-of-contents');
@endphp

<x-daisy::layout.docs title="Table Of Contents" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
