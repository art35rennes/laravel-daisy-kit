@php
    ...
    $props = DocsHelper::getComponentProps('navigation', 'pagination');
@endphp

<x-daisy::layout.docs title="Pagination" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Pagination</h1>
        <p>Pagination pour naviguer entre les pages.</p>
    </section>
        ...
        <div class="tabs tabs-box">
            ...
            <div class="tab-content border-base-300 bg-base-100 p-6">
                <div class="not-prose flex flex-wrap items-center gap-3">
                    ...
                    <x-daisy::ui.navigation.pagination size="sm">Small</x-daisy::ui.navigation.pagination>
                    <x-daisy::ui.navigation.pagination size="lg">Large</x-daisy::ui.navigation.pagination>
                </div>
            </div>
