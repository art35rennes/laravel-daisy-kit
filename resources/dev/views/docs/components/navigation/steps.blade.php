@php
    ...
    $props = DocsHelper::getComponentProps('navigation', 'steps');
@endphp

<x-daisy::layout.docs title="Steps" :sidebarItems="$navItems" :sections="$sections" :currentRoute="request()->path()">
    <x-slot:navbar>
        <div class="join">
    ...
    <section id="intro">
        <h1>Steps</h1>
        <p>Indicateur d'étapes dans un processus.</p>
    </section>
