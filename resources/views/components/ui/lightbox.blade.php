...
<div id="{{ $id }}" data-lightbox="1" data-loop="{{ $loop ? 'true' : 'false' }}" data-keyboard="{{ $keyboard ? 'true' : 'false' }}" data-zoom="{{ $zoom ? 'true' : 'false' }}" data-fullscreen="{{ $fullscreen ? 'true' : 'false' }}" class="space-y-2">
