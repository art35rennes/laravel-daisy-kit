...
<div class="code-editor {{ $classes }}" id="{{ $id }}" data-language="{{ $language }}" data-readonly="{{ $readonly ? 'true' : 'false' }}" data-theme="{{ $theme ?? '' }}" data-tab-size="{{ (int)$tabSize }}" style="width: {{ $width }};">
    @if($showToolbar)
