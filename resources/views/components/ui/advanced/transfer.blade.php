    ...
    <div class="grid grid-cols-1 {{ $break }}:grid-cols-12 gap-4 items-stretch w-full">
        ...
        <div class="card bg-base-100 card-border h-full min-w-0 col-span-12 {{ $break }}:col-span-5">
            <div class="card-body gap-3 p-4">
                        ...
                        @if($selectAll)
                            <label class="label cursor-pointer justify-start gap-3 p-0">
                                ...
                                <span class="min-w-0 leading-tight">
                                    <span class="card-title text-base leading-tight">{{ $titleSource }}</span>
                                    <span class="block truncate text-xs text-base-content/60">{{ $selectAllTextSource }}</span>
                                </span>
                            </label>
                        @else
                            <h3 class="card-title text-base leading-tight">{{ $titleSource }}</h3>
                        @endif
                    </div>
                ...
                <ul class="menu menu-sm w-full bg-base-100 rounded-box card-border p-2 {{ $overflowClasses }}" data-transfer-list="source">
        ...
        <div class="card bg-base-100 card-border h-full min-w-0 col-span-12 {{ $break }}:col-span-5">
            <div class="card-body gap-3 p-4">
                    ...
                    <div class="min-w-0">
                        @if($selectAll)
                            <label class="label cursor-pointer justify-start gap-3 p-0">
                                ...
                                <span class="min-w-0 leading-tight">
                                    <span class="card-title text-base leading-tight">{{ $titleTarget }}</span>
                                    <span class="block truncate text-xs text-base-content/60">{{ $selectAllTextTarget }}</span>
                                </span>
                            </label>
                        @else
                            <h3 class="card-title text-base leading-tight">{{ $titleTarget }}</h3>
                        @endif
                    </div>
                ...
                <ul class="menu menu-sm w-full bg-base-100 rounded-box card-border p-2 {{ $overflowClasses }}" data-transfer-list="target">
