export const defaultLabels = {
    ...
    loading: 'Loading…', retry: 'Retry', loadMore: 'Load more', loadError: 'This branch could not be loaded.',
    searchError: 'The search could not be loaded.', filterError: 'The custom tree filter failed.', empty: 'No tree items are available.',
